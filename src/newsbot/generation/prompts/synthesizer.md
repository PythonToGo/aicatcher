...
Your job is to synthesize them into a coherent narrative — finding patterns, connections, and the big picture.
...
```
{
  ...
  "trend_analysis": "<3–5 paragraph trend analysis in Korean. Connect the dots across items. Identify the dominant theme, emerging patterns, and what this week's news collectively signals for the field.>"
}
```
